...
if(isset($_GET['P_id']))
{
	...
	if($rows>0)
	{
		$row=mysqli_fetch_row($cmd);
			...
			$_SESSION["cpid"]=$pid;
			$_SESSION["cpname"]=$pname;
			$_SESSION["cpcat"]=$pcat;
			$_SESSION["cpavl"]=$pavl;
			$_SESSION["cpprice"]=$pprice;
			$_SESSION["cpcom"]=$pcom;
			$_SESSION["cpdes"]=$pdes;
			$_SESSION["cplink"]=$plink;
			$_SESSION["cpiof"]=$piof;
			$_SESSION["cppo"]=$pop;
			...
			<div class="row s_product_inner">
						...
						<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
							<ol class="carousel-indicators">
								<li data-target="#carouselExampleIndicators" data-slide-to="0" class="active">
									<img src="<?php echo $plink; ?>" alt="" height="60px" width="60px">
								</li>
							...
							<div class="carousel-inner">
								<div class="carousel-item active">
									<img class="d-block w-100" src="<?php echo $plink; ?>" alt="First slide">
								</div>
								<div class="carousel-item">
									<img class="d-block w-100" src="<?php echo $plink; ?>" alt="Second slide">
								</div>
								<div class="carousel-item">
									<img class="d-block w-100" src="<?php echo $plink; ?>" alt="Third slide">
								</div>
							</div>
						</div>
					</div>
				...
				<div class="col-lg-5 offset-lg-1">
					<div class="s_product_text">
						...
						<h2><?php if($piof){ echo "$pop ₹.<br><strike>$pprice</strike>"." INR(₹) Per Unit"; } else {echo $pprice." INR(₹) Per Unit"; }?></h2>
						<ul class="list">
							<li>
								<a class="active" href="#">
									<span>Category</span> : <?php echo $pcat; ?></a>
							</li>
							<li>
								<a href="#">
									<span>Availibility</span> : <?php echo $pavl; ?> Items Are Left</a>
							</li>
						</ul>
						<p><?php echo $pdes; ?></p>
					<form action="add_cart.php" method="post">	
						<div class="product_count">
							...
							<input type="number" name="qty" id="sst"   oninput="validity.valid||(value='');" maxlength="12" value="1" title="Quantity:" class="input-text qty" min="1" max="5">
						</div>
						<div class="card_area">
							<input type="submit" name="submit" value="Add to Cart" class="main_btn"></a>

							
							<a href="add_cart.php?f=single-product&p_id=<?php echo $row[0]; ?>" class="main_btn">Buy Now</a> 
							<!-- <input type="submit" name="submit" value="Buy Now" class="main_btn"></a> -->
