		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-6">
					...
					<?php if(isset($_SESSION['error'])){echo "<font color='red'>Invalid Username or Password</font>"; unset($_SESSION['error']); } ?>
						<h3>Log in to enter</h3>
						<form class="row login_form" action="insert_login.php" method="post" id="contactForm">
							<div class="col-md-12 form-group">
								<input type="text" class="form-control" id="name" name="aduname" placeholder="User Id" required="required">
							</div>
							<div class="col-md-12 form-group">
								<input type="password" class="form-control" id="name" name="adpass" placeholder="Password" required="required">
							</div>
							<!--<div class="col-md-12 form-group">
							...
							<div class="col-md-12 form-group">
								<button name="submit" type="submit" value="submit" class="btn submit_btn">Log In</button>
